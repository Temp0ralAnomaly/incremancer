...
(() => {
        ...
        constructor() {
           ...
           new he(304, "Technical Think Tank", this.constructionTypes.TechThinkTank, {
                ...
                this.upgrades = [new le(1, "Bloodthirst", this.types.damage, this.costs.blood, 50, 1.2, 1, 40, "Your zombies thirst for blood and do +1 damage for each rank of Bloodthirst.", null, null),
                                 ...
                                 new le(14, "Spit it Out", this.types.spitDistance, this.costs.blood, 5e5, 1.6, 5, 10, "The first rank gives your zombies the ability to spit plague at enemies beyond normal attack range. Spit attacks do 50% zombie damage and infect the victim with plague. Subsequent ranks will increase the range of spit attacks.", null, 218),
                                 ...
                                 new le(47, "Bulletproof", this.types.bulletproof, this.costs.bones, 6e4, 1.6, .05, 5, "Craft your earth golems from much harder stone. Each rank gives them 5% chance to reflect bullets back to their source.", null, 220),
    ...
    class Ae {
        ...
        inflictPlague(e) {
            e.flags.infected ? (e.plagueDamage += (this.model.zombieDamage / 2 + this.model.plagueDamageMod, e.plagueTicks = this.model.plagueticks) * this.model.PlagueVatPCMod) : (this.exclamations.newPoison(e), e.plagueDamage = (this.model.zombieDamage / 2 + this.model.plagueDamageMod) * this.model.PlagueVatPCMod, e.plagueTicks = this.model.plagueticks), e.flags.infected = !0
        }
        updateBurns(e, t) {
